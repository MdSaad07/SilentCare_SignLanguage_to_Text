...
import os, sys
os.environ["ENCHANT_LIBRARY_PATH"] = "C:/Program Files (x86)/Aspell/bin"
import traceback
import pyttsx3
...
# Try initializing the English dictionary
try:
    dictionary = enchant.Dict("en_US")
    ddd = enchant.Dict("en_US")
    print("Dictionary loaded successfully!")
except enchant.errors.DictNotFoundError:
    print("Dictionary for 'en-US' not found. Please verify Aspell installation.")
